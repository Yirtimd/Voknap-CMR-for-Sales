...
.ui-drawer { display:flex; flex-direction:column; width:min(430px,100vw); height:100%; border-left:1px solid var(--color-border); background:var(--color-surface); box-shadow:var(--shadow-drawer); }
...
.ui-drawer__footer { display:flex; justify-content:flex-end; gap:var(--space-2); border-top:1px solid var(--color-border-subtle); padding:var(--space-4) var(--space-6); }
...
@media(max-width:640px){.ui-drawer,.ui-drawer.is-wide{width:100vw;border-left:0}.ui-drawer__header,.ui-drawer__body,.ui-drawer__footer{padding-inline:var(--space-4)}}
