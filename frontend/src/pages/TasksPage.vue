...
.tasks-search { position:relative; display:block; }.tasks-search span { position:absolute; top:50%; left:12px; z-index:1; color:var(--t-muted); transform:translateY(-50%); }.tasks-search input,.tasks-select { width:100%; height:38px; border:1px solid var(--t-border-strong); border-radius:var(--radius-control); outline:0; color:var(--t-text); background:#fff; font-size:12px; }.tasks-search input { padding:0 12px 0 35px; }.tasks-select { padding:0 9px; }.tasks-search input:focus,.tasks-select:focus { border-color:var(--t-primary); box-shadow:0 0 0 3px rgb(11 114 231 / 10%); }
.tasks-view-toggle { display:flex; }.tasks-view-toggle button { width:42px; padding:0; border-radius:0; }.tasks-view-toggle button:first-child { border-radius:var(--radius-control) 0 0 8px; }.tasks-view-toggle button:last-child { margin-left:-1px; border-radius:0 8px 8px 0; }.tasks-view-toggle button.active { z-index:1; border-color:#9bc8ff; color:var(--t-primary); background:#f5f9ff; }
.tasks-shell { display:grid; grid-template-columns:minmax(0,1fr) 300px; gap:20px; align-items:start; }.tasks-main { min-width:0; }.tasks-ai-focus { overflow:hidden; margin-bottom:16px; border:1px solid #e7e1ff; border-radius:var(--radius-panel); background:linear-gradient(180deg,#fbfaff,#f8f6ff); box-shadow:0 2px 8px rgb(83 56 163 / 4%); }.tasks-ai-focus > header { display:flex; align-items:center; min-height:44px; padding:0 14px; border-bottom:1px solid #ece7ff; }.tasks-ai-focus > header div { display:flex; align-items:center; gap:8px; }.tasks-ai-focus h2 { margin:0; font-size:13px; }.tasks-ai-focus header small { padding:3px 8px; border-radius:var(--radius-pill); color:var(--t-purple); background:var(--t-purple-soft); font-size:10px; }.ai-spark { color:var(--t-purple); }
...
.tasks-priority { display:inline-flex; align-items:center; width:fit-content; height:22px; padding:0 8px; border-radius:var(--radius-pill); font-size:10px; font-weight:700; white-space:nowrap; }.tasks-priority.is-high { color:#ef4444; background:#fff0f0; }.tasks-priority.is-medium { color:#d77b00; background:#fff7e6; }.tasks-priority.is-low { color:#16a36a; background:#eaf8f1; }
...
.tasks-group-stack { display:grid; gap:10px; }.tasks-group { overflow:hidden; border:1px solid var(--t-border); border-radius:var(--radius-panel); background:#fff; box-shadow:0 1px 3px rgb(15 23 42 / 2%); }.tasks-group__header { display:flex; align-items:center; justify-content:space-between; width:100%; min-height:44px; padding:0 14px; }.tasks-group__header > span:first-child { display:flex; align-items:center; gap:8px; }.tasks-group__header strong { font-size:13px; }.tasks-group__header small { display:grid; place-items:center; min-width:22px; height:22px; border-radius:var(--radius-pill); padding:0 6px; color:var(--t-primary); background:var(--t-primary-soft); font-size:10px; font-weight:700; }.group-chevron { color:var(--t-secondary); transition:transform 150ms ease; }.tasks-group__header[aria-expanded="false"] .group-chevron { transform:rotate(-90deg); }
